...
- This project шы related to the processing of the Eurostat dataset: "Gross domestic product (GDP) at current market prices by NUTS 2 regions". Eurostat online data code of this dataset: NAMA_10R_2GDP.
